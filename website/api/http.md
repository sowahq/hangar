...
Hangar's native HTTP API uses a flat path layout: `/:bucket/:objectKey`. Admin routes live under `/admin/*` and are unauthenticated — see [Configuration › Security](../configuration.md#security-notes).
